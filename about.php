...
/**
 * Template Name: Da Nang Tech About
 *
...
<?php get_template_part('template-parts/head-banner'); ?>
    ...
    <div class="container">
        <div class="px-md-4 px-lg-5">
            <div class="row g-5 align-items-center justify-content-center flex-column-reverse flex-md-row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/whoiam.png" alt="About Us">
                </div>
            </div>
        </div>
    </div>
