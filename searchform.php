 ...
 */
$search_text = apply_filters( 'genesis_search_text', __( 'Tìm kiếm...', 'dntech' ) );
 ...
 */
$search_button_text = apply_filters( 'genesis_search_button_text', esc_attr__( 'Tìm kiếm', 'genesis' ) );
